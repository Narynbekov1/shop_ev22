...
class CreateOrderView(generics.CreateAPIView):
    serializer_class= serializers.OrdeSerializer
...
class UserOrderList(views.APIView):
    ...
    def get(self, request):
        ...
        serializer = serializers.OrdeSerializer(orders, many=True).data
...
class UpdateOrderStatusView(views.APIView):
    ...
    def patch(self, request, pk):
        ...
        order.status = status
        order.save()
        serializer = serializers.OrderItemSerializer(order).data
